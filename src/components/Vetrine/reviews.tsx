...
const reviewCards = [
  {
    review:
      "Incredible APIs with robust features. Integration was a breeze and the documentation was crystal clear.",
    reviewer: {
      name: "Leo Thomson",
  ...
  {
    review:
      "Customer support went above and beyond when we encountered issues. Highly recommend!",
    reviewer: {
      name: "Emilia Soto",
  ...
  {
    review:
      "A solid selection of APIs, although I encountered some latency with a couple of services.",
    reviewer: {
  ...
  {
    review:
      "The variety of APIs is impressive, and the pricing model is very startup-friendly!",
    reviewer: {
      name: "Priya Bansal",

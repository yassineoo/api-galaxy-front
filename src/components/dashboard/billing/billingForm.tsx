        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-2 px-2 py-1 lg:py-3 border border-black bg-white text-black rounded-lg">
            <input
              ...
              name="paymentMethod"
              value="local-cards"
              checked={paymentMethod === "local-cards"}
              onChange={handleRadioChange}
              className="mr-2"
            />
            <label htmlFor="local-cards" className="flex flex-col">
              <span>Edahabia or CIB</span>
              <div className="flex space-x-2">
                <img className="w-10 lg:w-10" src="/images/algeriePoste.svg" />
                <img className="w-14 lg:w-14" src="/images/carteCib.svg" />
              </div>
            </label>
          </div>
        </div>

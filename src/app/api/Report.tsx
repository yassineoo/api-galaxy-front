...
export const Report= ({
    ...
    const handleSubmit = async (e:React.FormEvent)=>{
        ...
        const success = await reportAnAPI({description,screenshots:uploadedImages},api_id,userId)
        if(success){
            setDescription("")
  ...
  return (
    <div>
      ...
      <label htmlFor="screenshots" className=' text-slate-500 text-sm opacity-80 font-semibold'>Upload Screenshots (optional)</label>
        <CldUploadButton
      ...
      <button type="submit" className="cursor-pointer my-3 bg-green-500 text-white hover:bg-green-400 p-2">
        submit
      </button>
    </form>
    </div>

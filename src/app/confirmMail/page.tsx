...
const page = () => {
  ...
  return (
    ...
    <div className="contanier w-full mx-auto px-4 bg-white min-h-screen">
      {/* verify my password */}
      <div className="absolute top-[10rem] right-[50%] translate-x-[50%] shadow-xl rounded-3xl flex flex-col items-center max-w-sm w-full p-4">
        {/* your logo */}
        ...
        />
        <button
          className="my-4 py-4 bg-goldColor font-semibold rounded-md w-5/6 text-black mb-5"
        >
          Continuer
        </button>

        {/* retour */}
        <span onClick={()=>router.back()} className="underline text-seconadryColor mb-5">retour</span>
      </div>
    </div>
    </>
  )

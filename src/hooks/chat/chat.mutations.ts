...
import { chatroomsServiceUrl } from "./chat.queries";
import { ChatMessage, ChatWithMessages } from "@/app/dashboard/inbox/chat.interface";
...
export function useCreateMessageMutation(chatId: number) {
    ...
    return useMutation({
        ...
        mutationFn: async (input: {
            ...
            const res = await axios.post(`${chatroomsServiceUrl}/${chatId}/messages`, input)
